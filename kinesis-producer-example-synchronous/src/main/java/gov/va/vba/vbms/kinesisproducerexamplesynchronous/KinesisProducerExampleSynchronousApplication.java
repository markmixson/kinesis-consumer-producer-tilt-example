package gov.va.vba.vbms.kinesisproducerexamplesynchronous;
...
import gov.va.vba.vbms.kinesisproducerexamplesynchronous.stream.*;
...
public class KinesisProducerExampleSynchronousApplication {
    ...
    */
	...
	KinesisProducerExampleSynchronousApplication(SDKPublisher publisher) {
		this.publisher = publisher;
	}

	public static void main(String[] args) {
		SpringApplication.run(KinesisProducerExampleSynchronousApplication.class, args);
	}
